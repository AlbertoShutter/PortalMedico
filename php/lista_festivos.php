    ...
    <body>
        ...
        <section id="container">
            ...
            <table>
                ...
                <?php
                //Paginador
                $sql_register = mysqli_query($conection, "SELECT COUNT(*) as total_festivos FROM festivos");
                ...
                $query = mysqli_query($conection, "SELECT codigo, u.nombre, tipo, fecha FROM festivos f INNER JOIN usuario u ON f.medico = u.Id ORDER BY fecha ASC LIMIT $desde,$por_pagina;");
